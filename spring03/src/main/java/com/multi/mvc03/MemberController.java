...
public class MemberController {
	...
	public String login2(MemberVO bag, HttpSession session) {
		System.out.println("login요청됨");
		System.out.println(bag);
		int result = dao.login(bag);
		if (result == 1) {
	...
	/*
	 * @RequestMapping("one") public void one(mySQL_memberVO bag, Model model) {
	 * System.out.println("검색 요청됨"); System.out.println(bag); mySQL_memberVO bag2 =
	 * dao.one(bag); model.addAttribute("bag2", bag2); }
	 */
