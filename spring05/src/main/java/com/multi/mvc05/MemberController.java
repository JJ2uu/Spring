...
public class MemberController {
	...
	/*
	 * @RequestMapping("login") public String login(MemberVO bag, Model model) {
	 * System.out.println("login요청됨"); System.out.println(bag); MemberVO bag2 =
	 * dao.login(bag); model.addAttribute("bag2", bag2); return "one"; }
	 */
